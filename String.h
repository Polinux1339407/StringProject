...
public:
	...
	String(const char* cStr); // Constructor for a sequence of characters
	String(const String& other); // Copy constructor
	String(String&& other) throw(); // Move constructor
	~String(); // Destructor
	char* cStr() const; // C-string
	...
	String& operator=(const char* cStr); // Assignment operator with copying (C-style)
	String& operator+=(const String& other); // Increment operator
	String& operator+=(const char* cStr); // Increment operator (C-style)
